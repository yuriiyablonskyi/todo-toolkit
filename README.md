...
- **Edit tasks**: Modify task details to keep information up-to-date.
- **Delete tasks**: Remove tasks that are no longer needed.
- **Asynchronous actions**: Every action (delete, modify, add) sends an asynchronous request to jsonplaceholder.typicode.com.
- **Skeleton screen**: Enhances user experience during data fetching.
